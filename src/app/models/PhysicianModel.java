...
public class PhysicianModel {
    ...
    private static ArrayList<PhysicianController> db = new ArrayList<PhysicianController>();

    public static PhysicianController save(PhysicianController physician) {
        db.add(physician);
        return physician;
    }

    public static PhysicianController findById(int id) {
        PhysicianController physician = null;
        for (int i = 0; i < db.size(); i++) {
            PhysicianController p = db.get(i);
            if (p.getId() == id) {
                physician = p;
            }
        }
    ...
    public static ArrayList<PhysicianController> all() {
        seed();
        return db;
    }

    public static boolean update(int id, PhysicianController physician) {
    ...
    public static ArrayList<PhysicianController> findByExpertise(String exp) {
      ArrayList<PhysicianController> matches = new ArrayList<PhysicianController>();
      ArrayList<PhysicianController> phys = all();
      for (PhysicianController ph: phys){
    ...
    public static void seed() {
        ...
        PhysicianController.create(1, "Dr. Ashly Tatnell", "978 Monica Circle", "+690-500-3079", new String[]{"Physiotherapy", "Rehabilitation"});
...
//        TreatmentDb.save(tr2);
        ...
        PhysicianController.create(2, "Dr. Wye Brockwell", "71906 Waywood Circle", "+790-994-9953", new String[]{"Osteopathy", "Rehabilitation"});
...
//        TreatmentDb.save(tr4);
         ...
         PhysicianController.create(3, "Dr.Cybil Everix", "41 Russell Pass", "+930-229-2270", new String[]{"Physiotherapy","Osteopathy", "Rehabilitation"});
...
//        TreatmentDb.save(tr7);
         ...
         PhysicianController.create(4, "Jeddy Strongel", "79818 Transport Hill", "+885-418-8711", new String[]{ "Rehabilitation"});
...
//        
       PhysicianController.create(5, "Dr. Joana Terren", "39 Muir Circle", "+224-521-3171", new String[]{"Physiotherapy", "Osteopathy"});
